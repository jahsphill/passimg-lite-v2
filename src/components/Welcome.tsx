  ...
  const steps = [
    {
      ...
      description: 'Upload your original image to generate a secure digital fingerprint and prove your ownership.',
      icon: FileImage,
    ...
    },
    {
      ...
      description: 'Instantly check any copy of an image to see if it matches the registered original.',
      icon: ShieldCheck,
    ...
    },
    {
      ...
      description: 'Keep your registered images safe in your personal history database and account vault.',
      icon: Lock,
    ...
    },
    {
      ...
      description: 'List your verified images for sale, transfer ownership safely, and earn money directly.',
      icon: ShoppingBag,
    ...
    <div className="relative min-h-[85vh] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 select-none overflow-hidden" id="welcome-page-landing">
      ...
      <div className="w-full max-w-4xl space-y-12 z-10 text-center">
        ...
        <div className="space-y-4 max-w-3xl mx-auto" id="welcome-caption-area">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white md:leading-[1.15]">
          ...
          <p className="text-xs sm:text-sm text-slate-400 max-w-lg mx-auto leading-relaxed">
            Keep your photographs protected with a secure digital registry and easy-to-understand ownership certificates.
          </p>
        </div>
        ...
        <div className="glass rounded-3xl border border-white/10 bg-slate-900/10 p-6 sm:p-8 relative overflow-hidden group shadow-2xl" id="welcome-illustration-board">
          ...
          <div className="flex items-center justify-center space-x-2 pt-6 mt-6 border-t border-white/5 text-[10px] text-slate-500 font-mono">
            ...
            <span>PassIMG Secure Digital Ownership and Registry Standard</span>
          </div>
        </div>
