...
export default function Sidebar({
  ...
  return (
    <>
      {/* 1. Universal Sidebar Drawer Overlay (slid-in drawer panel for all screen sizes) */}
      {isOpenMobile && (
        <div className="fixed inset-0 z-50 flex" id="sidebar-mobile-overlay-wrapper">
          ...
          <div 
            className="relative flex w-72 max-w-xs flex-col bg-[#070b13] p-5 shadow-2xl border-r border-[#1eff00]/10 h-screen animate-in slide-in-from-left duration-200"
