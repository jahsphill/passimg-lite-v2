          ...
          <div className={`p-6 sm:p-8 rounded-2xl border ${
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="space-y-1 text-left">
                  ...
                  <h3 className="text-xl font-bold text-white flex items-center gap-2">
                    <span>{isVerified ? "Exact Match Found" : "Exact Match Not Found"}</span>
              ...
              <div className="flex flex-row items-center gap-3 shrink-0">
                <span className={`h-3 w-3 rounded-full ${isVerified ? 'bg-emerald-400 animate-pulse' : 'bg-rose-400'}`} />
                <span className="text-xs font-semibold text-slate-300 font-mono uppercase">
                  {isVerified ? "CRYPTOGRAPHIC_SAFE" : "INTEGRITY_COMPROMISED"}
                </span>
              </div>
